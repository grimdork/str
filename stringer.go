...
// Stringer extends strings.Builder.
...
// NewStringer returns a new Stringer.
...
func (s *Stringer) SetComma(c rune) *Stringer {
	s.comma = c
	return s
}

// SetEquals sets the symbol to join keys and values in maps.
func (s *Stringer) SetEquals(e rune) *Stringer {
	s.equals = e
	return s
}
...
// Write writes any number of different types at once.
// Special notes:
...
func (s *Stringer) Write(v ...interface{}) (int, error) {
	var err error
	var size, c int
